...
def Differentiation():
    ...
    for i in range(0,m):
        ...
        dR1dT1_a = - m_a * Cp('a',(T[j+3]+T[j+1])/2) + 1.0/2.0/R('pipe') + 1.0/2.0/R('int') + 1.0/2.0/R('ext')
        if j == 0:
            #Do nothing
            pass
        else:
        ...
        dR1dT3_a = m_a * Cp('a',(T[j+3]+T[j+1])/2.0) + 1.0/2.0/R('pipe') + 1.0/2.0/R('int') + 1.0/2.0/R('ext')
...
q = Residue(m,T)
print "This is the heat balance array:"
print q
print 
dQ = Differentiation()
