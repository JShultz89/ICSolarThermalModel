...
def Differentiation(q,T):
    ...
    for i in range(0,m):
        ...
        dRdT[j+1,j] = T[j+2] - dR1dT2_a/q[j+1]
        ...
        dRdT[j+2,j] = T[j+2] - dR2dT2_w/q[j+2]
        ...
        dRdT[j+2,j+2] = T[j+4] - dR2dT4_w/q[j+2]
        ...
        dRdT[j+3,j+1] = T[j+3] - dR2dT3_a/q[j+3]
